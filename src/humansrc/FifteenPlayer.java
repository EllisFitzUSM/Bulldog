 ...
 * humansrc.FifteenPlayer, a player that quits if the # score they make in a round is 15 or more.
 */
public class FifteenPlayer extends Player {
    ...
    public int play() {
        ...
        System.out.println("humansrc.Player " + getName() + " has decided to end their turn because their turn total has reached over 15.");
        return rollTotal;
    }
